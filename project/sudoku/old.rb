...
def main
  ...
  #p result_map
  result_map = answer(result_map, empty_points_arr, 
    unshow_values_by_x_arr, unshow_values_by_y_arr, unshow_values_by_group_arr, 
    group_null_point_arr)
#  guess_point_map, result_map = answer(result_map, empty_points_arr, 
#    unshow_values_by_x_arr, unshow_values_by_y_arr, unshow_values_by_group_arr, 
#    group_null_point_arr)
#  if guess_point_map
#    guess(guess_point_map,result_map, empty_points_arr, 
#      unshow_values_by_x_arr, unshow_values_by_y_arr, unshow_values_by_group_arr, 
#      group_null_point_arr)
#  end
  puts "The answer is:"
